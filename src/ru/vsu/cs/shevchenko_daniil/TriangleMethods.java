...
public class TriangleMethods {
    ...
    private static boolean CheckCorrectnessTriangle(Triangle triangle){
        double x1 = triangle.p1.getX(); double y1 = triangle.p1.getY();
        double x2 = triangle.p2.getX(); double y2 = triangle.p2.getY();
        double x3 = triangle.p3.getX(); double y3 = triangle.p3.getY();
    ...
    public static double Area(Triangle triangle) {
        ...
        if (!CheckCorrectnessTriangle(triangle)) {
            System.out.println("Некорректный треугольник");
            System.exit(1);
        }
    ...
    public static boolean IsPointInTriangle(Triangle triangle, Point point) {
        /*
        ...
        double x0 = point.getX(); double y0 = point.getY();
        double x1 = triangle.p1.getX(); double y1 = triangle.p1.getY();
        double x2 = triangle.p2.getX(); double y2 = triangle.p2.getY();
        double x3 = triangle.p3.getX(); double y3 = triangle.p3.getY();
